...
parser.add_argument("model", help="Path to the trained model (.h5)", type=str, default="")
...
#test on simple data
all_values = [56.0, 90.0, 114.0]#last days evolution
latlng = [46.131357,-2.4364346]#france
duration = 15#15 days after 22/01/2020
